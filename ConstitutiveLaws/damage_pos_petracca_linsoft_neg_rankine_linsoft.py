...
The class to call the constitutive law for the:
    ...
    Tension:        Petracca Yield Surface
                    Linear Softening
    Compression:    Rankine Yield Surface
                    Linear Softening
'''

class PosPetraccaLinSoftNegRankineLinSoft(object):
    ...
    def GetStress(self, effective_stress):
        ...
        with tf.name_scope("NegEquiStress"):           
            equivalent_stress_neg = YieldCriterion.Rankine.NegativeEquivalentStress\
                    (effective_stress)
