        ...
        with graph.as_default():
            ...
            with tf.name_scope("Variables"):
                ...
                with tf.name_scope("DamageModelVariables"):
                    ...
                    if bezier_applied == "Yes":
                        vars_nl_limit = var_type_nl.ConstrainVariables(vars_nl, vars_le_limit,  init_var_values)
                    else:
            ...
            with tf.name_scope("DamageLaw"):    
                ...
                with tf.name_scope('PredictedStress'):
                    ...
                    SIG_EFF_POS =nl_model(SIG_EFF, vars_le_limit, vars_nl_limit).GetPositiveEffectiveStress
                    SIG_EFF_NEG =nl_model(SIG_EFF, vars_le_limit, vars_nl_limit).GetNegativeEffectiveStress
            '''
            --------------------------------------------------------------------------
            ...
            with tf.name_scope("Optimization"):
                ...
                optimizer_nl  = optim_nl(l_rate_le).minimize(train_nl, var_list = VARS_nl)
