...
class GraphSplitApproach(object):
    def Run():
        ...
        #sig_eff_pos_le = Inputs.GetPositiveEffectiveStressLinear
        #sig_eff_neg_le = Inputs.GetNegativeEffectiveStressLinear
        ...
        #sig_eff_pos_nl = Inputs.GetPositiveEffectiveStressNonlinear
        #sig_eff_neg_nl = Inputs.GetNegativeEffectiveStressNonlinear
        ...
        sig_pos_nl_train, sig_pos_nl_test, \
        sig_neg_nl_train, sig_neg_nl_test, \
        sig_eff_pos_nl_train, sig_eff_pos_nl_test, \
        sig_effe_neg_nl_train, sig_eff_neg_nl_test = \
            Inputs.SplitTrainingAndTesting3Entries(eps_nl, sig_pos_nl, sig_neg_nl, \
            sig_eff_pos_nl, sig_eff_neg_nl)
        '''
        ...
        with graph.as_default():
            ...
            with tf.name_scope("Placeholders"):
                ...
                #SIG_EFF_POS = tf.placeholder(tf.float32, name = 'SIGMA_EFF_POS')
                #SIG_EFF_NEG = tf.placeholder(tf.float32, name = 'SIGMA_EFF_NEG')
